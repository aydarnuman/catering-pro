...
describe('Auth API', () => {
  ...
  describe('POST /api/auth/login', () => {
    ...
    test('Eksik email ile 400 dönmeli', async () => {
      try {
    ...
    test('Eksik şifre ile 400 dönmeli', async () => {
      try {
        const response = await request(API_URL)
          .post('/api/auth/login')
    ...
    test('Yanlış credentials ile 401 dönmeli', async () => {
      try {
        const response = await request(API_URL)
          .post('/api/auth/login')
          .send({ 
  ...
  describe('GET /api/auth/me', () => {
    ...
    test('Geçersiz token ile 401 dönmeli', async () => {
      try {
        const response = await request(API_URL)
          .get('/api/auth/me')
  ...
  describe('POST /api/auth/register', () => {
    ...
    test('Eksik alanlarla 400 dönmeli', async () => {
      try {
        const response = await request(API_URL)
