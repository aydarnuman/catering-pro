...
// Constants → utils/file-helpers.js'den import (tek kaynak)
const SUPPORTED_EXTENSIONS = SUPPORTED_EXTENSIONS_IMPORTED;
const CONTENT_TYPES = CONTENT_TYPES_IMPORTED;
...
// Doc type display names → utils/file-helpers.js'e taşındı (getDisplayNameUtil üzerinden erişilir)
