...
registerReports([
  {
    id: 'operasyon-personel',
    module: 'operasyon',
    label: 'Personel Listesi',
    description: 'Tüm personel bilgileri',
    icon: 'users',
    formats: ['excel', 'pdf'],
    category: 'personel',
    generator: 'operasyon:personelListesi',
  },
  {
    id: 'operasyon-stok',
    module: 'operasyon',
    label: 'Stok Listesi',
    description: 'Tüm ürün/stok bilgileri',
    icon: 'package',
    formats: ['excel', 'pdf'],
    category: 'stok',
    generator: 'operasyon:stokListesi',
  },
  {
    id: 'operasyon-kritik-stok',
    module: 'operasyon',
    label: 'Kritik Stok Raporu',
    description: 'Kritik seviyenin altındaki ürünler',
    icon: 'alert-circle',
    formats: ['excel', 'pdf'],
    category: 'stok',
    generator: 'operasyon:kritikStok',
  },
  {
    id: 'operasyon-demirbas',
    module: 'operasyon',
    label: 'Demirbaş Listesi',
    description: 'Sabit kıymet ve demirbaş envanterin',
    icon: 'tool',
    formats: ['excel', 'pdf'],
    category: 'demirbas',
    generator: 'operasyon:demirbasListesi',
  },
  {
    id: 'operasyon-satin-alma',
    module: 'operasyon',
    label: 'Satın Alma Siparişleri',
    description: 'Satın alma sipariş kayıtları',
    icon: 'shopping-cart',
    formats: ['excel', 'pdf'],
    category: 'satin-alma',
    generator: 'operasyon:satinAlmaListesi',
  },
  {
    id: 'operasyon-bordro',
    module: 'operasyon',
    label: 'Bordro Raporu',
    description: 'Dönem bazlı bordro bilgileri',
    icon: 'report-money',
    formats: ['excel', 'pdf'],
    category: 'personel',
    requiresContext: true,
    contextType: 'donem',
    generator: 'operasyon:bordroRaporu',
  },
]);
