-- =============================================
-- 001: USER SESSIONS TABLOSU VE FONKSİYONLARI
-- Session yönetimi için gerekli yapılar
-- =============================================

-- 1. REFRESH_TOKENS TABLOSU (eğer yoksa)
...
-- 4. AKTİF SESSION SAYISI FONKSİYONU
...
-- 5. EN ESKİ AKTİF SESSION FONKSİYONU
...
-- 6. SESSION SONLANDIRMA FONKSİYONU
...
-- 7. DİĞER SESSION'LARI SONLANDIRMA FONKSİYONU
...
-- 8. SÜRESİ DOLMUŞ SESSION'LARI TEMİZLE
