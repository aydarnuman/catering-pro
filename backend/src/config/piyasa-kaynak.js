...
export const KATEGORI_SITELERI = {
  ...
  paketli: [...REFERANS_SITELERI.karsilastirma, ...REFERANS_SITELERI.toptan, ...REFERANS_SITELERI.market],
  // Taze meyve-sebze
  taze: [...REFERANS_SITELERI.tarim, ...REFERANS_SITELERI.karsilastirma],
  // Et, süt, peynir, yoğurt, tereyağı
  et_sut: [...REFERANS_SITELERI.karsilastirma, ...REFERANS_SITELERI.toptan, ...REFERANS_SITELERI.market],
  // Toptan / büyük ambalaj
  toptan_buyuk: [...REFERANS_SITELERI.toptan, ...REFERANS_SITELERI.karsilastirma],
  // Temizlik, sarf malzemesi
  temizlik: [...REFERANS_SITELERI.karsilastirma, ...REFERANS_SITELERI.market],
};
