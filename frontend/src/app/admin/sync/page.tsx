    ...
    <Container size="xl" py="md">
      <Stack gap="lg">
        ...
        <Tabs value={activeTab} onChange={setActiveTab}>
          ...
          <Tabs.Panel value="invoices" pt="xl">
            <Stack gap="lg">
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="lg" fw={600}>📊 Manuel Fatura Senkronizasyonu</Text>
                    <Button
                      leftSection={schedulerStatus?.isRunning ? <IconPlayerStop size={16} /> : <IconPlayerPlay size={16} />}
          ...
          <Tabs.Panel value="tenders" pt="xl">
            <Stack gap="lg">
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="lg" fw={600}>🔍 İhale Tarama Kontrolü</Text>
                    <Button
                      leftSection={tenderSchedulerStatus?.isRunning ? <IconPlayerStop size={16} /> : <IconPlayerPlay size={16} />}
                  ...
                  <Text size="sm" c="dimmed">
                    İhale sitelerinden yeni ihaleleri tarayıp veritabanına kaydedin. 
                    Sayfa sayısı arttıkça tarama süresi uzar.
                  </Text>
                  ...
                  <Alert icon={<IconClock size={16} />} color="blue" variant="light">
                    <Text size="sm" fw={600}>Otomatik Tarama Zamanları:</Text>
          ...
          <Tabs.Panel value="backup" pt="xl">
            <Stack gap="lg">
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Text size="lg" fw={600}>💾 Yedekleme İşlemleri</Text>
                  ...
                  <SimpleGrid cols={{ base: 1, sm: 2 }}>
                    <Stack>
                      <Text size="sm" fw={600}>Manuel Yedekleme</Text>
                      <Button
                    ...
                    <Stack>
                      <Text size="sm" fw={600}>Yedekten Geri Yükle</Text>
                      <Button
                  ...
                  <Stack gap="xs">
                    <Text size="sm" fw={600}>Yedekleme Ayarları</Text>
                    <Group>
                      <Switch 
                        label="Otomatik yedekleme aktif"
                        defaultChecked
                      />
                      <Select
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="lg" fw={600}>📦 Mevcut Yedekler</Text>
                  ...
                  <Table striped highlightOnHover>
                    ...
                    <Table.Tbody>
                      <Table.Tr>
                        ...
                        <Table.Td>
                          <Badge color="blue" size="sm">Otomatik</Badge>
                        </Table.Td>
                      ...
                      <Table.Tr>
                        ...
                        <Table.Td>
                          <Badge color="green" size="sm">Manuel</Badge>
                        </Table.Td>
            ...
            <Stack gap="lg">
              ...
              <SimpleGrid cols={{ base: 1, sm: 2, md: 4 }}>
                <Paper withBorder p="md" radius="md">
                  ...
                  <Text fw={700} size="xl">{databaseStats?.invoices?.total || 0}</Text>
                  <Text size="xs" c="dimmed">
                ...
                <Paper withBorder p="md" radius="md">
                  ...
                  <Text fw={700} size="xl">{databaseStats?.tenders?.total || 0}</Text>
                  <Text size="xs" c="dimmed">
                ...
                <Paper withBorder p="md" radius="md">
                  ...
                  <Text fw={700} size="xl">{databaseStats?.documents?.total || 0}</Text>
                  <Text size="xs" c="dimmed">
                ...
                <Paper withBorder p="md" radius="md">
                  ...
                  <Text fw={700} size="xl">{databaseStats?.database?.sizePretty || '0 MB'}</Text>
                  <Progress 
                    value={databaseStats?.database?.size ? (databaseStats.database.size / (1024 * 1024 * 1024)) * 100 : 0} 
                    color="orange" 
                    size="xs" 
                    mt="xs" 
                  />
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Text size="lg" fw={600}>📊 Tablo Bilgileri</Text>
                    ...
                    <Table.Tbody>
                      {databaseStats?.tables?.map((table: any, index: number) => (
                        <Table.Tr key={table.name}>
                          <Table.Td>
                            <Group gap="xs">
                              {table.name.includes('invoice') ? <IconFileInvoice size={14} /> : 
                               table.name.includes('tender') ? <IconGavel size={14} /> :
                               table.name.includes('document') ? <IconFileText size={14} /> :
                          ...
                          <Table.Td>
                            {databaseStats?.tableSizes?.[index]?.size || 'N/A'}
                          </Table.Td>
                          <Table.Td>
                            {table.lastUpdate ? dayjs(table.lastUpdate).format('DD.MM.YYYY HH:mm') : '-'}
                          </Table.Td>
                        </Table.Tr>
                      )) || (
                        <Table.Tr>
              ...
              <Card withBorder shadow="sm" p="lg">
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="lg" fw={600}>🤖 AI ile Sorgulama</Text>
                    <Button
                      size="xs"
                      variant="light"
                  ...
                  <Alert icon={<IconSparkles size={16} />} color="violet" variant="light">
                    <Stack gap="xs">
                      <Text size="sm" fw={500}>AI Chat ile yapabilecekleriniz:</Text>
        ...
        <Card withBorder shadow="sm" p="lg">
          <Stack gap="md">
            <Group justify="space-between">
              <Text size="lg" fw={600}>📝 Son İşlem Logları</Text>
              <Button
                size="xs"
                variant="subtle"
                ...
                <Table.Tbody>
                  {syncLogs.slice(0, 10).map((log, index) => (
                    <Table.Tr key={log.id || index}>
                      ...
                      <Table.Td>
                        <Text size="sm" fw={500} c="blue">{log.invoices_synced || 0}</Text>
                      </Table.Td>
                      <Table.Td>
                        <Text size="sm" fw={500} c="green">{log.new_invoices || 0}</Text>
                      </Table.Td>
                      <Table.Td>
                        {log.error_message && (
