...
const sonIslemler = [
  { id: 1, tip: 'gelir', aciklama: 'Metro İhale Ödemesi', tutar: 45000, tarih: '02.01.2026', durum: 'tamamlandi' },
  { id: 2, tip: 'gider', aciklama: 'Personel Maaşları', tutar: -28500, tarih: '01.01.2026', durum: 'tamamlandi' },
  { id: 3, tip: 'gelir', aciklama: 'Okul Yemekhane Faturası', tutar: 18750, tarih: '30.12.2025', durum: 'beklemede' },
  { id: 4, tip: 'gider', aciklama: 'Malzeme Alımı - Metro', tutar: -12400, tarih: '28.12.2025', durum: 'tamamlandi' },
  { id: 5, tip: 'gider', aciklama: 'Araç Yakıt', tutar: -3200, tarih: '27.12.2025', durum: 'tamamlandi' },
];
        ...
        <Stack gap="xl">
          ...
          <SimpleGrid cols={{ base: 1, lg: 2 }}>
            ...
            <Card withBorder shadow="sm" p="lg" radius="md">
              <Group justify="space-between" mb="md">
                <div>
                  ...
                  <Text size="sm" c="dimmed">Aylık karşılaştırma</Text>
                </div>
            ...
            <Card withBorder shadow="sm" p="lg" radius="md">
              <Group justify="space-between" mb="md">
                <div>
                  <Text fw={600} size="lg">Gider Dağılımı</Text>
                  <Text size="sm" c="dimmed">Kategorilere göre</Text>
                </div>
                <ActionIcon variant="subtle" color="gray">
                  <IconDotsVertical size={18} />
                </ActionIcon>
          ...
          <SimpleGrid cols={{ base: 1, lg: 2 }}>
            ...
            <Card withBorder shadow="sm" p="lg" radius="md">
              <Group justify="space-between" mb="md">
                <div>
                  <Text fw={600} size="lg">Son İşlemler</Text>
                  <Text size="sm" c="dimmed">Son 5 hareket</Text>
                </div>
                  ...
                  <Table.Tbody>
                    {sonIslemler.map((islem) => (
                      <Table.Tr key={islem.id}>
                        ...
                        <Table.Td>
                          <Text size="sm" c="dimmed">{islem.tarih}</Text>
                        </Table.Td>
                        <Table.Td style={{ textAlign: 'right' }}>
                          <Text 
                            size="sm" 
                            fw={600} 
                            c={islem.tutar > 0 ? 'green' : 'red'}
                          >
                            {islem.tutar > 0 ? '+' : ''}{formatMoney(islem.tutar)}
                          </Text>
                        </Table.Td>
                      </Table.Tr>
                    ))}
            ...
            <Card withBorder shadow="sm" p="lg" radius="md">
              <Group justify="space-between" mb="md">
                <div>
                  <Text fw={600} size="lg">Yaklaşan Ödemeler</Text>
                  <Text size="sm" c="dimmed">Vadesi yaklaşan faturalar</Text>
                </div>
                  ...
                  >
                    <Group justify="space-between">
                      <div>
                        ...
                        <Group gap="xs">
                          <Text size="sm" c="dimmed">Vade: {fatura.vadeTarihi}</Text>
                          <Badge 
                            size="sm" 
          ...
          <SimpleGrid cols={{ base: 2, md: 4 }}>
            <Paper withBorder p="md" radius="md">
              <Group>
                ...
                <div>
                  <Text size="xs" c="dimmed" tt="uppercase">Aktif Cariler</Text>
                  <Text fw={700} size="xl">48</Text>
                </div>
              </Group>
            </Paper>
            <Paper withBorder p="md" radius="md">
              <Group>
                ...
                <div>
                  <Text size="xs" c="dimmed" tt="uppercase">Bu Ay Fatura</Text>
            ...
            <Paper withBorder p="md" radius="md">
              <Group>
                ...
                <div>
                  <Text size="xs" c="dimmed" tt="uppercase">Stok Kalem</Text>
            ...
            <Paper withBorder p="md" radius="md">
              <Group>
                ...
                <div>
                  <Text size="xs" c="dimmed" tt="uppercase">Banka Bakiye</Text>
                  <Text fw={700} size="xl">{formatMoney(485000)}</Text>
                </div>
              </Group>
            </Paper>
          </SimpleGrid>
