...
export function WhatsAppWidget() {
  ...
  const getStatusIcon = (status?: string) => {
    switch (status) {
      ...
      case 'sent':
        return <IconCheck size={12} color="rgba(255,255,255,0.7)" />;
      case 'delivered':
        return <IconChecks size={12} color="rgba(255,255,255,0.7)" />;
      case 'read':
        return <IconChecks size={12} color="#53BDEB" />;
      case 'error':
                        ...
                        <Box>
                          ...
                          >
                            ...
                            <Group gap={4} justify="flex-end" mt={2}>
                              <Text size="xs" c={msg.fromMe ? 'rgba(255,255,255,0.7)' : 'gray.6'}>
                                {msg.timestamp}
                              </Text>
                              {msg.fromMe && getStatusIcon(msg.status)}
                            </Group>
                            {msg.status === 'error' && (
                              <Text size="xs" c="white" ta="center" mt={4} fw={500}>
                                ⟳ Tekrar dene
                              </Text>
                            )}
                          </Paper>
              ...
              >
                ...
                <Group gap="xs">
                  ...
                  <Menu shadow="md" width={160} position="top-start">
                    <Menu.Target>
                      <ActionIcon variant="subtle" color="gray" size="sm" loading={sendingMedia}>
      ...
      <Group wrap="nowrap" gap="sm">
        ...
        <Box style={{ flex: 1, overflow: 'hidden' }}>
          <Group justify="space-between" wrap="wrap">
            <Text fw={500} c="white" size="sm" truncate>
              {chat.name}
            </Text>
            <Text size="xs" c="gray.6">
              {chat.timestamp}
